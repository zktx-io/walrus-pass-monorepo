import { JWT_ERROR, JWTHeader, JWTPayload, JWTVerifyOptions, verifyJWT } from 'did-jwt'
import { VerificationMethod } from 'did-resolver'
import { verifyJWTDecoded } from './verifyJWTDecoded'
import { resolveAuthenticator } from './resolveAuthenticator'
...
export async function verifyConditionWeightedThreshold(
  jwt: string,
...
export async function verifyConditionDelegated(
  jwt: string,
  { header, payload, data, signature }: JWTDecoded,
  authenticator: VerificationMethod,
  options: JWTVerifyOptions
